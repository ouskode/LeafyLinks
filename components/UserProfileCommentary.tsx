...
const UserProfileCommentary = () => {
  return (
    <View style={styles.contentBlockSmall}>
      <Image
        style={styles.imageIcon}
        resizeMode="cover"
        source={require('../assets/images/imageRose.png')} // Ensure you use the correct path to your image
      />
...
export default UserProfileCommentary;
